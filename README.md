...
|[Blue Team Labs Online (BTLO)](https://blueteamlabs.online/)|🆕 NEW — A gamified platform for cyber defenders to practice security investigations and challenges covering Incident Response, Digital Forensics, Security Operations, and Reverse Engineering.|
...
|[Bug Bounty Hunter](https://www.bugbountyhunter.com/)|🆕 NEW — Free training platform created by bug bounty hunter zseano, teaching how to find and report web application vulnerabilities in real bug-bounty programs.|
...
|[CloudGoat (AWS)](https://github.com/RhinoSecurityLabs/cloudgoat)|🆕 NEW — A deliberately vulnerable AWS infrastructure by Rhino Security Labs for learning cloud-pentesting techniques; spins up vulnerable scenarios you can attack and tear down.|
|[Crackmes.one](https://crackmes.one/)|🆕 NEW — A free, community-driven place to download crackmes to practice and improve your reverse-engineering skills, with submissions and a leaderboard.|
|[CTFlearn](https://ctflearn.com/)|🆕 NEW — Beginner-friendly CTF platform with hundreds of free challenges across crypto, forensics, web, reversing, and stego, plus an active learning community.|
|[CryptoHack](https://cryptohack.org/)|🆕 NEW — A free, fun platform for learning modern cryptography by solving challenges and cracking insecure code, from classic ciphers to RSA, AES, and post-quantum crypto.|
...
|[CyberDefenders](https://cyberdefenders.org/)|🆕 NEW — Free platform to upskill and benchmark SOC analysts with real-world cyber-range investigations, blue-team challenges, and structured learning paths.|
|[CyberTalents](https://cybertalents.com/)|🆕 NEW — Global platform where cybersecurity talents can learn, practice, compete, and get ranked through free CTFs, courses, and competitions.|
...
|[EchoCTF](https://echoctf.com/)|🆕 NEW — Cyber range built by Echothrust Solutions for running CTFs and trainings on real IT infrastructure, including fully functional smart-city dioramas with 200+ hackable elements.|
...
|[Hack The Box Academy](https://academy.hackthebox.com/)|🆕 NEW — Free tier of Hack The Box Academy's structured cybersecurity learning paths and modules covering offensive, defensive, and general security skills.|
...
|[Hacker101](https://www.hacker101.com/)|🆕 NEW — Free web-security class from HackerOne with videos, write-ups, and an always-on Capture the Flag to practice your bug-bounty skills.|
...
|[HackTricks](https://book.hacktricks.xyz/)|🆕 NEW — A free cybersecurity knowledge base with practical pentesting, red-team, web, cloud, binary exploitation, and privilege-escalation techniques, contributed by the community.|
...
|[LetsDefend](https://letsdefend.io/)|🆕 NEW — Hands-on blue-team training platform with learning paths, MITRE ATT&CK-mapped courses, and browser-based incident-response challenges for SOC analysts.|
...
|[OWASP MASTG Crackmes](https://github.com/OWASP/mastg/tree/master/Crackmes)|🆕 NEW — A set of reverse-engineering and cracking challenges for Android and iOS apps, maintained by the OWASP Mobile Application Security (MAS) project to accompany the MASTG.|
...
|[PortSwigger Web Security Academy](https://portswigger.net/web-security)|🆕 NEW — Free online training center for web application security from PortSwigger, with hands-on labs covering topics like XSS, SQL injection, SSRF, authentication, and deserialization.|
...
|[pwn.college](https://pwn.college/)|🆕 NEW — Free hands-on cybersecurity education platform where learners develop and practice core cybersecurity skills, from Linux basics to memory corruption and exploitation.|
...
|[RingZer0 CTF](https://ringzer0ctf.com/)|🆕 NEW — Online CTF with tons of challenges across cryptography, forensics, web exploitation, reverse engineering, and steganography.|
