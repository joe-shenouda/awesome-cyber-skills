...
|[Hacksplaining](https://www.hacksplaining.com/)|This is a place to learn basics of system, network and web-app/website hacking. These are easy to deal and are both theoretical and practical labs activities, for beginners and intermediate|
...
|[TryHackMe](https://tryhackme.com/)|The new place to tingle around for getting started in Cyber Security field. TryHackMe is being one of the greatest place to learn and gain knowledge. It consists of both labs and practical theories, that will never bore you|
