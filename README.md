...
|[VuCSA](https://github.com/Warxim/vucsa)|VuCSA is an open-source vulnerable client-server application for learning penetration testing of applications with custom protocols (built on TCP).|
