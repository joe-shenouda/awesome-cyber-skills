...
|[OWASP Juice Shop](https://owasp.org/www-project-juice-shop/)|OWASP Juice Shop is a vulnerable web-application designed to train enthusiasts in web-application security. It encompasses all the vulnerabilities from the OWASP Top 10 list along with other common real life security flaws.|
